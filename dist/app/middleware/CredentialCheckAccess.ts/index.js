...
const credentialCheckAccess = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (tokenVerify === undefined) {
        res.status(404).send((0, forceReturnType_1.default)({
            message: constants_1.default.MESSAGE_ERROR_NOT_FOUND_TOKEN,
        }));
        return;
    }
    try {
        ...
        res.status(401).send((0, forceReturnType_1.default)({
            message: constants_1.default.MESSAGE_ERROR_NOT_PERMISSION,
        }));
    }
});
exports.default = credentialCheckAccess;
